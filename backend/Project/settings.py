...
SECRET_KEY = "django-insecure-x-4-gi@^u6rnz4p9!jpa&@bw+9t5mytcl5)dnckcmkmg51q0"
...
# STATICFILES_DIRS = [os.path.join(BASE_DIR, 'LyCentric/frontend/dist')]
...
CORS_ALLOWED_ORIGINS = [
    'http://localhost:5173',
    'https://lycentric-wears.onrender.com'
]
